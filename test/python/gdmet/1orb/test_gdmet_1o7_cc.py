...
class test_hemb_ci_1o3(unittest.TestCase):
    ...
    def test_grisb_ci(self):
        ...
        for U in Us:
            ...
            # test CC solver
            # restrict=True, with spin symmetry. For Mott insulator try restrict=False. For metal, try restrict=True
            ...
            grisb.run(itmax=200, mix=0.4, tol=5e-3, beta=5000,
            ...
            grisb.compute_Gf_Sig(0.0, eks, oms, 0.05)
            Gfk = grisb.Gf
            print(Gfk.shape)    
            ...
            fo = open('U_docc_Z_gdmet_1o7_cc.dat','a')
